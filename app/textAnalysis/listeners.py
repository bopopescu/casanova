...
def materias_relacionadas(sender, context, request, content, **kw):
    # from entidade.models import Entidade
    # entidades = entidades_citadas_no_formulario(context, request)
    # json = Entidade.to_json(entidades)
    content.write(render_to_string('admin/materia/materia/materias_relacionadas.html', {'json_entidades':"json"})) 
    
pre_extensible_area.connect( materias_relacionadas,
