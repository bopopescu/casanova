...
# 
#     kernel=RadialBasisKernel(0.5) #PolynomialKernel(5)
#     
#     kwargs = dict(event_size=len(centers[0]), outcome_size=len(centers), kernel=kernel)  
#     p = Perceptron(**kwargs)
#     
#     for _ in xrange(500):
#         event, outcome = sample(2)
