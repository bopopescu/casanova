...
def wfinder():
    import nltk
    root = '/Users/demetrius/nltk_data/corpora/demetrius/'
    r = nltk.corpus.PlaintextCorpusReader(root,'.*\.cvs', encoding='utf-8')
    word_finder(r)
...
def wordfrequency():
    ...
    wordfrequency = count.items()
    res = []
    for (w, f) in wordfrequency:
    	res.append((f, w))
